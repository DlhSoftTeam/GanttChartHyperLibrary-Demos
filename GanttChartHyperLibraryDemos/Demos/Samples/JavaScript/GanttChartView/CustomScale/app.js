...
// Define scales.
settings.scales = [{ scaleType: 'NonworkingTime', isHeaderVisible: false, isHighlightingVisible: true, highlightingStyle: 'stroke-width: 0; fill: #f8f8f8' },
                   ...
                   {
                       scaleType: 'Custom', headerTextFormat: 'Custom', headerStyle: 'padding: 2.25px; border-right: solid 1px White; color: Gray',
                       intervals: function () {
                           var intervals = [];
