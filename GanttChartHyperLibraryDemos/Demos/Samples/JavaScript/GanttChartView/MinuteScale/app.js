...
var minuteIntervals = getIntervals(minuteDuration, function (d) { return (d.getMinutes() < 10 ? '0' : '') + d.getMinutes(); });
...
var minuteScale = { scaleType: 'Custom', headerTextFormat: 'Custom', intervals: minuteIntervals, headerStyle: 'padding: 7px 5px; border-right: 1px solid White; color: gray' };
// Define scales.
settings.scales = [
    hourQuarterScale,
    minuteScale,
