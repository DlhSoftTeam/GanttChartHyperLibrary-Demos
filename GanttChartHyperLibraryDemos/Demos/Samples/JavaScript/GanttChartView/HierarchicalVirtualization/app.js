...
function loadHierarchy(item) {
    ...
    switch (item.content) {
        ...
        case "Task 2":
            ...
            break;
        case "Task 2.2":
            subItems = [{ content: "Task 2.2.1", start: new Date(year, month, 11, 8, 0, 0), finish: new Date(year, month, 14, 16, 0, 0), completedFinish: new Date(year, month, 14, 16, 0, 0), assignmentsContent: "Resource 2" },
                        { content: "Task 2.2.2", start: new Date(year, month, 12, 12, 0, 0), finish: new Date(year, month, 14, 16, 0, 0), assignmentsContent: "Resource 2" }];
            break;
    }
