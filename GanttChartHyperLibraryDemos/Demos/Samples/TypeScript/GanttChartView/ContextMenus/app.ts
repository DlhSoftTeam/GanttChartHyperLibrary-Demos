...
function itemContextMenuHandler(e: MouseEvent, item: GanttChartItem) {
...
function predecessorItemContextMenuHandler(e: MouseEvent, predecessorItem: PredecessorItem, targetItem: GanttChartItem) {
...
var contextMenuItem: GanttChartItem;
var contextMenuPredecessorItem: PredecessorItem;

function deleteItemContextMenuClicked(e: MouseEvent) {
    ganttChartView.removeItem(contextMenuItem);
    hideContextMenus();
    e.stopPropagation();
}

function deleteDependencyContextMenuClicked(e: MouseEvent) {
